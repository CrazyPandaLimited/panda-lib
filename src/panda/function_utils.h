...
template <typename Ret, typename... Args, typename Functor,
          bool IsComp = lib::traits::is_comparable<std::remove_reference_t<Functor>>::value,
          typename DeFunctor = std::remove_reference_t<Functor>,
          typename = std::enable_if_t<lib::traits::has_call_operator<Functor, Ifunction<Ret, Args...>&, Args...>::value ||
                                      lib::traits::has_call_operator<Functor, Args...>::value>,
...
template <typename Ret, typename... Args, typename Functor,
          bool IsComp = lib::traits::is_comparable<typename std::remove_reference<Functor>::type>::value,
          typename DeFunctor = std::remove_reference_t<Functor>,
          typename = std::enable_if_t<lib::traits::has_call_operator<Functor, Ifunction<Ret, Args...>&, Args...>::value ||
                                      lib::traits::has_call_operator<Functor, Args...>::value>,
          typename = std::enable_if_t<!std::is_same<Functor, Ret(&)(Args...)>::value>,
